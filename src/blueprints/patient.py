...
# Importaciones corregidas desde los nuevos módulos db
...
# --- CORRECCIÓN CLAVE: VOLVER A NOMBRE SINGULAR ---
@patient_bp.route('/paciente/detalle/<int:patient_id>')
@login_required
def patient_detail(patient_id): # <--- SINGULAR
    connection = None
